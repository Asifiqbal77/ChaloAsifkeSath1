  ...
  return (
    <div>
      ...
      <div className="container py-5">
        <h2 className="text-center mb-4 fw-bold">Best Travel Agency in Lahore</h2>
        <hr className="mx-auto mb-5" style={{ width: "80px", borderTop: "3px solid #007bff" }} />
        ...
        <div className="row align-items-center">
          ...
          <div className="col-md-6">
            <p className="text-muted">
              <strong>Pakistan Travel Places</strong> is one of the best and most reliable tourism
              ...
              <br />
              <br />
              Don’t worry if you’re confused to find a trustworthy travel agency in Lahore, Pakistan.
      ...
      <div className="bg-light py-4 text-center">
        <h5 className="fw-semibold text-secondary mb-0">
          “Travel with comfort, explore with confidence — Pakistan Travel Places.”
        </h5>
      </div>
    </div>
  );
